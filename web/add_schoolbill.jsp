...
<body>
    <form id="form1" name="form1" method="post" action="gtr?a=SchBill">
...
%>          </td>
        ...
        <tr>
           <td>&nbsp;</td>
        <td width="146"><input name="buttonSubmit" type="submit" id="buttonSubmit" value="Add Record" onClick="return validateAssessment(form1)"></td>
         <td width="133"><label>           
        </label></td>
        </tr>
      </table>
