...
<body>
    <form id="form1" name="form1" method="post" action="gtr?a=Report&RepType=8">
  <table width="956" cellpadding="10" class="style5">
    <tr>
      <td width="689"><table width="919" border="0">
        ...
        <tr>
          <td align="right" class="style12">&nbsp;</td>
          <td valign="top" class="style12"><input name="buttonSubmit" type="submit" id="buttonSubmit" value="Generate Statement of Student"></td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
