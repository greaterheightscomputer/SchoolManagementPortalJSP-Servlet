...
<%@page import="java.util.Vector,java.util.Enumeration,java.util.Iterator,java.util.LinkedHashMap,java.util.Set,gtr.DAO.ClassDAO,gtr.DAO.AssessmentDAO,gtr.DAO.SessionDAO,gtr.DAO.SubjectDAO,gtr.DAO.ExamDAO"%>
...
<body>
    <form id="form1" name="form1" method="post" action="gtr?a=Report&RepType=4">
...
%></td>
        ...
        <tr>
          <td align="right" class="style12">&nbsp;</td>
          <td valign="top" class="style12"><input name="buttonSubmit" type="submit" id="buttonSubmit" value="Generate Registration Form"></td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
