...
<%@page import="java.util.Vector,java.util.Enumeration,java.util.Iterator,java.util.LinkedHashMap,java.util.Set,gtr.DAO.StaffDAO"%>
...
<body>
    <form id="form1" name="form1" method="post" action="gtr?a=Report&RepType=6">
  <table width="956" cellpadding="10" class="style5">
    <tr>
      <td width="689"><table width="919" border="0">
        ...
        <tr>
          <td align="right" class="style12">Staff Id : </td>
          <td valign="top" class="style12"><label>
                  <input name="textStaffId" type="text" id="textStaffId" size="30" maxlength="90" value="<%=staffId%>">
          </label></td>
           
         <tr>
          <td align="right" class="style12">&nbsp;</td>
          <td valign="top" class="style12"><input name="buttonSubmit" type="submit" id="buttonSubmit" value="Generate Staff Record"></td>
