...
<body>
    <form id="form1" name="form1" method="post" action="gtr?a=Report&RepType=7">
...
%></td>
        ...
        <tr>
          <td align="right" class="style12">&nbsp;</td>
          <td valign="top" class="style12"><input name="buttonSubmit" type="submit" id="buttonSubmit" value="Generate Result"></td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
          <td valign="top" class="style12">&nbsp;</td>
