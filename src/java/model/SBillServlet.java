 ...
 * @author Bun Sunusi
 */
public class SBillServlet extends HttpServlet {
...
//             out.print(classId+"<br>");
//             out.print(termId+"<br>");
//             out.print(accountname+"<br>");
//             out.print(accountno+"<br>");
//             out.print(previousbal+"<br>");
//             out.print(schoolfees+"<br>");
//             out.print(uniform+"<br>");
//             out.print(sportlevy+"<br>");
//             out.print(registrate+"<br>");
//             out.print(examlevy+"<br>");
//             out.print(pta+"<br>");
//             out.print(computerlevy+"<br>");
//             out.print(textbook+"<br>");
//             out.print(notebook+"<br>");
//             out.print(transport+"<br>");
//             out.print(lessonfees+"<br>");
//             out.print(endyear+"<br>");
//             out.print(graduatefees+"<br>");
//             out.print(total+"<br>");
...
//            }
            ...
            if(button.equals("Update Record")){
               ...
               int chkStudent = SchoolBillDAO.checkId(billId);
                if(chkStudent == 0){
                        int status = SchoolBillDAO.deleteRecord(billId);
                        if(status == 0){
